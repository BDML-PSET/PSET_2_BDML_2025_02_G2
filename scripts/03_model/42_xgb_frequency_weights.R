...
model = caret::train(pobre ~ .,
                     ...
                     trControl = trainControl(method = 'cv',
                                              ...
                                              classProbs = TRUE,
                                              verboseIter = TRUE),
                     tuneGrid = expand.grid(nrounds = c(500,600),
                                            max_depth = c(7,8,9),
                                            eta = c(0.04,0.05,0.07),
...
# #-------------#
# # 11. Export 
export(model,'02_model/output/42_xgb_tree_weights.rds')
export(final_predicitions,file = '02_model/output/42_xgb_tree_weights_optimize_sens_spec.csv')
export(final_predicitions_f1,file = '02_model/output/42_xgb_tree_weights_optimize_f1.csv')
export(predictions_bayes,file = '02_model/output/42_xgb_tree_weights_bayes_rule.csv')