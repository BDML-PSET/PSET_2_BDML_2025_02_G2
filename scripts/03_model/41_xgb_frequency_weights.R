...
# #-------------#
# # 11. Export 
export(model,'02_model/output/41_xgb_tree_weights_nrounds_500_max_depth_7_eta_0.04_gamma_0_col_sample_0.6_min_n_25_ss_0.8.rds')
export(final_predicitions,file = '02_model/output/41_xgb_tree_weights_optimize_sens_spec_nrounds_500_max_depth_7_eta_0.04_gamma_0_col_sample_0.6_min_n_25_ss_0.8.csv')
export(final_predicitions_f1,file = '02_model/output/41_xgb_tree_weights_optimize_f1_nrounds_500_max_depth_7_eta_0.04_gamma_0_col_sample_0.6_min_n_25_ss_0.8.csv')
export(predictions_bayes,file = '02_model/output/41_xgb_tree_weights_bayes_rule_nrounds_500_max_depth_7_eta_0.04_gamma_0_col_sample_0.6_min_n_25_ss_0.8.csv')