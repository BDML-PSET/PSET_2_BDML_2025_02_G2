...
set.seed(1234)
downSampledTrain <- downSample(x = df_train %>% select(-pobre),
                               y = df_train$pobre,
                               yname = 'pobre')
...
#-------------#
# 11. Export 
export(final_predicitions,file = 'stores/output/03_models/34_xgboost_trees_500_td_8_eta_0.03_min_n_25_gamma_0_cols_0.8_ss_0.9.csv')
