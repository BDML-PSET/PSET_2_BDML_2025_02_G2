...
model = caret::train(pobre ~ .,
                      ...
                      num.trees = 1000,
                      metric = 'F',
                      tuneGrid = expand.grid(mtry = c(12, 15,50,75,100,150),
...
# #-------------#
# # 11. Export 
export(model,'stores/output/03_models/33_rf_tree_weights_nrounds.rds')
export(final_predicitions,file = 'stores/output/03_models/33_rf_case_weights.csv')
export(final_predicitions_f1,file = 'stores/output/03_models/33_rf_optimize_f1_case_weights.csv')
export(predictions_bayes,file = 'stores/output/03_models/33_rf_tree_weights_bayes_rule.csv')
